...
def main():
    ...
    parser.add_argument('-f', '--filename_col', help='column name for the filename',
                        default='Sample')
    parser.add_argument('--basket_info', help='Flag to save basket info as a json object in resulting files.',
                        action='store_true')
    parser.add_argument('--ms2', help='match ms2 ions during basketing Note: Will drastically increase time required',
                        action='store_true')
