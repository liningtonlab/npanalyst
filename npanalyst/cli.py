...
#                     else:
#                         basket_path = data_path.joinpath("replicated").joinpath(
#                             "basketed.csv"
#                         )
#                 else:
...
#                     basket_path, args.activity_data, configd
#                 )
#                 # core.create_clusters(act_path, configd["OUTPUTDIR"])
#                 configd["MAXCLUSTERS"] = core.create_communitites(
#                     act_path, configd["OUTPUTDIR"]
#                 )
#                 core.save_config(baseDir, configd)
